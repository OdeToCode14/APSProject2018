...
// test for time from here
    ...
    hs_st3=hs_st1.find_intersection(hs_st2);
    ...
    start = high_resolution_clock::now();
    tr_st3=tr_st1.find_intersection(tr_st2);
    stop = high_resolution_clock::now();
    duration = duration_cast<microseconds>(stop - start);
    cout << "Time taken by tree_set find_intersection: "<< duration.count() << " microseconds\n";

    //Difference

    start = high_resolution_clock::now();
    
    hs_st3=hs_st1.find_difference(hs_st2);
    
    stop = high_resolution_clock::now(); 
    duration = duration_cast<microseconds>(stop - start);
    //cout<<"number of collisions "<<hs_st3.collision<<"\n";
    cout << "Time taken by hash_set find_difference: "<< duration.count() << " microseconds\n"; 
    //cout<<hs_st3.occupied<<"\n";
    //hs_st3.print();

    start = high_resolution_clock::now();
    tr_st3=tr_st1.find_difference(tr_st2);
    stop = high_resolution_clock::now();
    duration = duration_cast<microseconds>(stop - start);
    cout << "Time taken by tree_set find_difference: "<< duration.count() << " microseconds\n";
